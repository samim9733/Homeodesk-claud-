...
হোমিওপ্যাথি ওষুধ: Syzygium jambolanum Q, 30C; Uranium nitricum 30C; Phosphorus 30C; Abroma augusta Q; Cephalandra indica Q।
...
সারাংশ: প্রোস্টাগ্লান্ডিনের কারণে জরায়ুর সংকোচন। Mag phos দ্রুত উপশম দেয়।
...
হোমিওপ্যাথি ওষুধ: Cicuta virosa 30C, 200C (আঘাত পরবর্তী); Cuprum met 30C (শ্বাস বন্ধ, নীলাভ); Bufo 30C (যৌনাঙ্গের উদ্দীপনা সহ); Causticum 30C (রাতে, ভয়); Silicea 30C (মৃগী মন্দা)।
...
হোমিওপ্যাথি ওষুধ: Carduus marianus Q, 30C; Chelidonium 30C; Phosphorus 30C; Lycopodium 30C; Cholesterinum 6C (কলেস্টেরল কমায়)।
...
লক্ষণ: পায়ুপথের পাশে ক্ষত, পুঁজ ও রক্তস্রাব, স্থায়ী জল স্রাব, বসলে ব্যথা, কখনো কখনো জ্বর।
রোগ নির্ণয়: ক্লিনিক্যাল পরীক্ষা, ফিস্টুলোগ্রাফি (প্রয়োজনে)।
হোমিওপ্যাথি ওষুধ: Silicea 30C, 200C; Berberis vulgaris 30C; Hepar sulph 30C (তীব্র পুঁজ); Arsenicum album 30C (দুর্গন্ধ); Calcium fluoride 30C (শক্ত মাংস)।
...
রোগ নির্ণয়: এক্স-রে।
হোমিওপ্যাথি ওষুধ: Symphytum Q, 30C (হাড় জোড়ার জন্য অতুলনীয়); Calcarea phosphorica 30C (নতুন হাড় গঠন); Arnica 30C (প্রাথমিক ব্যথা ও শক); Ruta 30C (পেরিওস্টিয়ামের ক্ষতি)।
...
হোমিওপ্যাথি ওষুধ: Chelidonium 30C, 200C; Berberis vulgaris 30C; Lycopodium 30C; Nux vomica 30C; Dioscorea 30C (তীব্র ব্যথায়)।
...
হোমিওপ্যাথি ওষুধ: Physostigma 30C, 200C; Phosphorus 30C; Osmium 30C; Spigelia 30C (চোখের পেছনে ব্যথা); Gelsemium 30C (অলসতা)।
...
হোমিওপ্যাথি ওষুধ: Hamamelis Q, 30C (রক্তপাত সহ, কোমল); Aesculus 30C (পিঠে ব্যথা, পায়ুতে চাপ); Nux vomica 30C (কোষ্ঠকাঠিন্য থেকে); Aloe 30C (জেলি মতো স্রাব); Collinsonia 30C (গর্ভাবস্থায়)।
...
সারাংশ: দুর্বল পেশি দিয়ে অঙ্গ বেরিয়ে আসা। Lycopodium ও Nux vomica সহায়ক।
...
হোমিওপ্যাথি ওষুধ: Thyroidinum 6X, 30C, 200C; Calcarea carbonica 30C (স্থূল, ঠাণ্ডা, ঘাম); Lycopodium 30C (পেট ফাঁপা); Sepia 30C (মাথাব্যথা ও জরায়ুর সমস্যা); Graphites 30C (ত্বক শুষ্ক)।
...
const sectionsMap: { [key: string]: string } = {
    'ত্বক': 'Section G: ত্বকের রোগ',
    'গ্যাস্ট্রো': 'Section E: পরিপাকতন্ত্র',
    'মাসিক': 'Section I: স্ত্রীরোগ',
    'জ্বর': 'Section A: জ্বর ও সংক্রামক রোগ',
    'শ্বাস': 'Section C: শ্বাসতন্ত্রের রোগ',
    'কান': 'Section L: চোখ ও কানের রোগ',
    'মুখ': 'Section K: দন্ত ও মুখগহ্বর',
    'স্নায়ু': 'Section D: স্নায়ুতন্ত্র ও মানসিক',
    'পেশি': 'Section F: হাড় ও জয়েন্ট',
    'রক্তচাপ': 'Section B: হৃদরোগ ও সংবহনতন্ত্র',
    'লিভার': 'Section E: পরিপাকতন্ত্র',
    'কিডনি': 'Section J: মূত্রতন্ত্র',
    'অণ্ডকোষ': 'Section J: মূত্রতন্ত্র',
    'থাইরয়েড': 'Section N: বিপাক ও অন্তঃস্রাবী',
    'মাথা': 'Section D: স্নায়ুতন্ত্র ও মানসিক',
    'ঘুম': 'Section D: স্নায়ুতন্ত্র ও মানসিক',
    'মানসিক': 'Section D: স্নায়ুতন্ত্র ও মানসিক',
    'চোখ': 'Section L: চোখ ও কানের রোগ',
    'যৌনাঙ্গ': 'Section J: মূত্রতন্ত্র',
    'পায়ুপথ': 'Section E: পরিপাকতন্ত্র'
};
       ...
       current = {
        ...
        if (line.startsWith('লক্ষণ:')) {
            ...
            meds.forEach((m: string, idx: number) => {
                ...
                let actualName = name.replace(/ \d+(C|X|\d*M|K|Q).*$/, '').replace(/ Q.*$/, '').trim();
...
const content = fs.readFileSync('src/practiceMedicineData.ts', 'utf-8');
const exportIndex = content.lastIndexOf('];');

if (exportIndex !== -1) {
    const jsonStr = JSON.stringify(results, null, 2);
    // remove brackets
    const jsonToInsert = ',\n' + jsonStr.substring(2, jsonStr.length - 2);
    const newContent = content.substring(0, exportIndex) + jsonToInsert + content.substring(exportIndex);
    fs.writeFileSync('src/practiceMedicineData.ts', newContent);
    console.log('Successfully appended ' + results.length + ' records.');
} else {
    console.log('Export array end not found!');
}
